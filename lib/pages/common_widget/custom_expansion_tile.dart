...
//stessa cosa dell'expansion tile, ma i children li metto in uno wrap, anzichè in un column
//TODO: modificarlo meglio per usare solamente quello che serve
...
class CustomExpansionTile extends StatefulWidget {
  ...
  const CustomExpansionTile({
    ...
    this.controlAffinity,
          ...
          expandedCrossAxisAlignment != WrapCrossAlignment.start,
  ...
  final WrapCrossAlignment? expandedCrossAxisAlignment;
    ...
    final Widget result = Offstage(
      ...
      child: TickerMode(
        ...
        child: Padding(
          ...
          child: Wrap(
            crossAxisAlignment:
                widget.expandedCrossAxisAlignment ?? WrapCrossAlignment.center,
